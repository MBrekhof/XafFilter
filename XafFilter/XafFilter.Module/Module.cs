...
namespace XafFilter.Module
{
    // For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
    public sealed class XafFilterModule : ModuleBase
    {
        public XafFilterModule()
        {
            //
            // XafFilterModule
            //
            AdditionalExportedTypes.Add(typeof(XafFilter.Module.BusinessObjects.ApplicationUser));
